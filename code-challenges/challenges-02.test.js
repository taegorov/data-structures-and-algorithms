...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach((value) => {
    ...
    const raisedNumber = Math.pow(value, 3);
    // push into an array
...
const addOne = (arr) => {
  const newArray = [];
  arr.map((value) => {
    const incrementedNumber = value += 1;
    newArray.push(incrementedNumber);
  });
  return newArray;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i += 1) {
    const raisedNumber = Math.pow(2, arr[i])
    newArray.push(raisedNumber);
  }
  return newArray;
}
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach((value) => {
    const raisedNumber = Math.pow(2, value)
    newArray.push(raisedNumber);
  });
  return newArray;
}
